...
docker images
# menyesuaikan nama image dengan format Docker Hub
docker tag item-app:v1 k1zuko/item-app:v1
...
# meng-upload image ke Docker Hub
docker push k1zuko/item-app:v1
